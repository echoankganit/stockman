    ...
    if($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if($pcategory!='Select'){
            ...
            if (isset($_POST['cbpartyview'])){
                $sql = "SELECT * FROM `ssf_cashbook` WHERE `pcategory`='$pcategory' AND `pname`='$pname'";
                $sqlb = "SELECT * FROM `ssf_bankbook` WHERE `pcategory`='$pcategory' AND `pname`='$pname'";
                ...
                $sql2 = "SELECT SUM(amount) AS sumain FROM `ssf_cashbook` WHERE `pcategory`='$pcategory' AND `pname`='$pname' AND `amountentry`='in'";
                $sql3 = "SELECT SUM(amount) AS sumaout FROM `ssf_cashbook` WHERE `pcategory`='$pcategory' AND `pname`='$pname' AND `amountentry`='out'";
                $sql2b = "SELECT SUM(amount) AS sumbin FROM `ssf_bankbook` WHERE `pcategory`='$pcategory' AND `pname`='$pname' AND `amountentry`='in'";
                $sql3b = "SELECT SUM(amount) AS sumbout FROM `ssf_bankbook` WHERE `pcategory`='$pcategory' AND `pname`='$pname' AND `amountentry`='out'";
...
<head>
    ...
    <title>Party Wise Cash Book View - Stock Management System</title>
</head>
