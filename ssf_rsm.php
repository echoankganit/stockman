...
<body class="d-flex flex-column">
    <div class="flex-grow-1 flex-shrink-0">
        ...
        if (isset($_POST['available'])){
            $sql2 = "SELECT SUM(ricequantity) AS sumrqi FROM `ssf_rsm` WHERE `ricetype`='$ricetype' AND `ricequality`='$ricequality' AND `ricequantity`='$ricequantity' AND `rsmentry`='in'";
            $sql3 = "SELECT SUM(ricequantity) AS sumrqo FROM `ssf_rsm` WHERE `ricetype`='$ricetype' AND `ricequality`='$ricequality' AND `ricequantity`='$ricequantity' AND `rsmentry`='out'";
