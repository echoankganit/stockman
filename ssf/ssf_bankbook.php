    ...
    if($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if($pcategory!='Select'){
            ...
            if (isset($_POST['bbsubmit'])){
                $sql = "INSERT INTO `ssf_bankbook` (`purpose`, `source`, `bbdate`, `amount`, `receivedby`, `amountentry`, `location`, `pcategory`, `pname`) VALUES ('$purpose','$source','$bbdate','$amount','$receivedby','$amountentry','$location','$pcategory','$array[1]')";
                $pname = partyname();
                $pcategory = partycategory();
...
<head>
    ...
    <?php echo("<title>Bank Book$page_title</title>"); ?>
</head>
        ...
        <div class="col">
            <form method="GET" action="ssf_bankbook_view.php">
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="bbmonthview" name="bbdate" value="<?php echo date('Y-m-d') ?>" required>
                </div>
