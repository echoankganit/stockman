    ...
    if($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        /*if($stcontractor!='Select'){*/
            if (isset($_POST['masubmit'])){
                //$sql = "INSERT INTO `ssf_majduri` (`madate`, `stunits`, `stcontractor`) VALUES ('$madate','$stunits','$stcontractor')";
                $sql = "INSERT INTO `ssf_majduri` (`madate`, `maunits`, `macontid`, `macontname`) VALUES ('$madate','$maunits','$array[0]','$array[1]')";
...
<head>
    ...
    <title>Majduri - Sri Sri Foods</title>
</head>
<body class="d-flex flex-column">
    <div class="flex-grow-1 flex-shrink-0">
        <div class="d-flex justify-content-center">
            <p class="h1">MAJDURI</p>
        </div>
