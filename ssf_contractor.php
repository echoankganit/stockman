<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (isset($_POST['contsubmit'])){
            $sql = "INSERT INTO `ssf_contractor` (`contname`, `contaddress`, `contdate`) VALUES ('$contname','$contaddress', '$contdate')";
            ...
            if($result){
                ...
                (Contractor Unique ID: '.$row1['contid'].') <br>Contractor Name: <strong>'.$contname.'</strong><br>Contractor Address: <strong>'.$contaddress.'</strong><br>Date: <strong>'.$row1['contdate'].'</strong><br>
...
<head>
    ...
    <title>New Contractor Registration - Sri Sri Foods</title>
</head>
<body class="d-flex flex-column">
    <div class="flex-grow-1 flex-shrink-0">
        <div class="d-flex justify-content-center">
            <p class="h1">Contractor Registration</p>
        </div>
