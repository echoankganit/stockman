<?php
    ...
    if (isset($_GET['cbmonthview'])){
        $cbdate = mysqli_real_escape_string($db, $_GET['cbdate']);
        ...
        $sql = "SELECT * FROM `ssf_cashbook` WHERE YEAR(`cbdate`)='$cbyear' AND MONTH(`cbdate`)='$cbmonth'";
        $result = mysqli_query($db,$sql);
...
<head>
    ...
    <title>Cash Book View - Stock Management System</title>
</head>
