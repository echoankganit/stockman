<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $ksupname = mysqli_real_escape_string($db, $_POST['ksupname']);
        ...
        /*if($stcontractor!='Select'){*/
            if (isset($_POST['ksubmit'])){
                ...
                $sql = "INSERT INTO `ssf_khushboo` (`khushbooid`, `khushbooname`, `khushbooquality`, `ksupname`, `kdate`, `kunits`, `kentry`) VALUES ('$array[0]','$array[1]','$array[2]','$ksupname','$kdate','$kunits','$kentry')";
...
<head>
    ...
    <title>Khushboo - Sri Sri Foods</title>
</head>
    ...
    <div class="flex-grow-1 flex-shrink-0">
        ...
        <div class="container col-4">
            <form method="POST" action="">
                ...
                <div class="form-group">
                    <label for="ksupname">Supplier Name</label>
                    <input type="text" class="form-control" id="ksupname" name="ksupname" required>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
